        ...
        <main style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '50vh'}}>
            <form onSubmit={handleSubmit} style={{ backgroundColor: 'black', padding: '20px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0,0,0,0.1)' }}>
                <div style={{ marginBottom: '10px' }}>
                    <label style={{ display: 'block', marginBottom: '5px', color: 'white' }}>Item Name</label>
                    <input required type="text" onChange={handleName} value={name} placeholder="Item name" style={{ width: '100%', padding: '8px', boxSizing: 'border-box', backgroundColor: 'white', color: 'black' }} />
                </div>
                <div style={{ marginBottom: '10px' }}>
                    <label style={{ display: 'block', marginBottom: '5px', color: 'white' }}>Quantity</label>
                    <input required type="number" onChange={handleQuantity} value={quantity} min="1" style={{ width: '100%', padding: '8px', boxSizing: 'border-box', backgroundColor: 'white', color: 'black' }} />
                </div>
                <div style={{ marginBottom: '20px' }}>
                    <label style={{ display: 'block', marginBottom: '5px', color: 'white' }}>Category</label>
                    <select onChange={handleCategory} value={category} style={{ width: '100%', padding: '8px', boxSizing: 'border-box', backgroundColor: 'white', color: 'black' }}>
